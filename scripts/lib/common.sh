...
hcnews_init_cache_dirs() {
	local dirs=("weather" "exchange" "saints" "rss" "bicho" "didyouknow" "futuro" "header" "musicchart" "quote" "ru" "rss/rss_feeds" "rss/url_cache" "airquality" "earthquake" "onthisday" "sports" "hackernews")
	local full_paths=()
	for dir in "${dirs[@]}"; do
